...
\caption{Comparison of related VLA architectures. FM = Flow Matching,
         ...
         DT = Discrete Tokenisation, HS = Hidden State Conditioning.}
...
\hline
OpenVLA         & SigLIP + DINOv2 & Autoregressive  & Uniform bin  & \texttimes & \texttimes & \texttimes \\
GR00T N1        & SigLIP          & Diffusion (FM)  & Custom (CT)  & \checkmark & \checkmark & \texttimes \\
Diffusion-VLA   & SigLIP          & Diffusion (FM)  & FAST+  (DT)  & \checkmark & \texttimes & \texttimes \\
KILO-VLA        & SigLIP + DINOv2 & Autoregressive  & FAST+  (DT)  & \checkmark & \texttimes & \texttimes \\
\textbf{Ours}   & SigLIP + DINOv3 & Diffusion (FM)  & FAST+  (DT)  & \checkmark & \checkmark & \checkmark \\
\hline
\end{tabular}
\end{table}
